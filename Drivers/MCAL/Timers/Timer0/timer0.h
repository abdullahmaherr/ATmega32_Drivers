...
typedef struct
{
	...
	void (*Timer_ISR)(void);	/* SET The Call Back Function That Will Be Called In ISR*/
...
/* @ref TIMER0 Modes */
#define TIMER0_MODE_OVF						(0x00U)
#define TIMER0_MODE_CTC						(0x08U)
...
#define TIMER0_MASK_DISABLE					(0x00)
#define TIMER0_MASK_OVF_ENABLE				(0x01)
#define TIMER0_MASK_CTC_ENABLE				(0x02)
