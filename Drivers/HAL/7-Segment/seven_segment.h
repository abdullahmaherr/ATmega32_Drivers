...
#define SEVEN_SEGMENT_PORT					GPIOA_ID	/* Select The Port Where 7-Segment Connected to */
#define SEVEN_SEGMENT_FIRST_PIN				GPIO_PIN0	/* Select The First Pin Where 7-Segment Connected to */
#define SEVEN_SEGMENT_DECODER_IC			SEVEN_SEGMENT_WITHOUT_DECODER	/* Select The Decoder Connection */
